...
#define Functor0w1Ret_t(RT)             CBFunctor0wRet<RT>
...
public:
    CBFunctionTranslator0(Func f) : CBFunctor0(thunk, NULL, (void *) f, 0) { }
    static void thunk(const CBFunctorBase &ftor) {
        (Func(ftor.func))();
    }
};
...
public:
    CBFunctionTranslator2(Func f):CBFunctor2<P1, P2>(thunk, 0, (void *) f, 0) { }
    static void thunk(const CBFunctorBase &ftor, P1 p1, P2 p2) {
...
public:
    CBFunctionTranslator3(Func f):CBFunctor3<P1, P2, P3>(thunk, 0, (void *) f, 0) { }
    static void thunk(const CBFunctorBase &ftor, P1 p1, P2 p2, P3 p3) {
...
template <typename P1, typename P2, typename RT, typename Callee, typename MemFunc>
...
template <typename P1, typename P2, typename RT, typename Func>
...
template <typename P1, typename P2, typename RT, typename MemFunc>
...
template <typename P1, typename P2, typename RT,
        typename Callee, typename TRT, typename CallType, typename TP1, typename TP2>
inline CBMemberTranslator2wRet<P1, P2, RT, Callee, TRT (CallType::*)(TP1, TP2)>
...
template <typename P1, typename P2, typename RT,
        typename Callee, typename TRT, typename CallType, typename TP1, typename TP2>
inline CBMemberTranslator2wRet<P1, P2, RT, const Callee, TRT (CallType::*)(TP1, TP2) const>
makeFunctor(CBFunctor2wRet<P1, P2, RT>*, const Callee &c, TRT (CallType::* const &f)(TP1, TP2)const) {
    typedef TRT (CallType::*MemFunc)(TP1, TP2)const;
    return CBMemberTranslator2wRet<P1, P2, RT, const Callee, MemFunc>(c, f);
}

template <typename P1, typename P2, typename RT, typename TRT, typename TP1, typename TP2>
...
template <typename P1, typename P2, typename RT, typename TRT, typename CallType>
inline CBMemberOf1stArgTranslator2wRet<P1, P2, RT, TRT (CallType::*)()>
makeFunctor(CBFunctor2wRet<P1, P2, RT>*, TRT (CallType::* const &f)()) {
    typedef TRT (CallType::*MemFunc)();
    return CBMemberOf1stArgTranslator2wRet<P1, P2, RT, MemFunc>(f);
}

template <typename P1, typename P2, typename RT, typename TRT, typename CallType>
inline CBMemberOf1stArgTranslator2wRet<P1, P2, RT, TRT (CallType::*)() const>
makeFunctor(CBFunctor2wRet<P1, P2, RT>*, TRT (CallType::* const &f)() const) {
    typedef TRT (CallType::*MemFunc)() const;
    return CBMemberOf1stArgTranslator2wRet<P1, P2, RT, MemFunc>(f);
}

using Func0 = CBFunctor0;
template<typename P1> using Func1 = CBFunctor1<P1>;
template<typename P1, typename P2> using Func2 = CBFunctor2<P1, P2>;
template<typename P1, typename P2, typename P3> using Func3 = CBFunctor3<P1, P2, P3>;
template<typename P1, typename RT> using Func1R = CBFunctor1wRet<P1, RT>;
template<typename P1, typename P2, typename RT> using Func2R = CBFunctor2wRet<P1, P2, RT>;
